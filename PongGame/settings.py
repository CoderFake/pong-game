...
if ENV != "dev":
    ...
    CSRF_TRUSTED_ORIGINS = os.environ.get('CSRF_TRUSTED_ORIGINS', 'http://localhost:20000,http://127.0.0.1:21000').split(',')
...
ASGI_APPLICATION = "PongGame.asgi.application"  # For WebSocket support
